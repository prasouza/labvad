...
REM echo.[Remember to reset your board right before uploading.]
REM echo.Enter the first character of your choice...
REM set abuild_choice=
REM set /p abuild_choice=Upload, Quit? 

REM if /i "!abuild_choice!" == "q" (
REM     goto success
REM )

REM if /i "!abuild_choice!" == "u" (
    call aupload.bat !abuild_hex!
