...
// By S.Brandao                                       *
// 13/09//2012 -  5130 bytes  Alterado em: 09/12/2014 *
// Experiencia do Curso - Servo   - Grupo Miscelanea  *
//*****************************************************
#include <Servo.h>
...
void setup() 
{ 
  Meu_servo.attach(12); // Servo está conectado no I/O(7)
  Serial.begin(9600);
  pinMode(RELE,OUTPUT);
 ...
 pinMode(saida_7,OUTPUT);  // Pino_7 SERVO_Angulos
 pinMode(LED_VM, 0);  // Pino_9
 pinMode(LED_VD, 0);  // Pino_10 
 pinMode(LED_AZ, 0);  // Pino_11
} 
